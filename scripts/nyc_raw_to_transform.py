...
## @type: DataSource
## @args: [database = "nyc", table_name = "raw_green", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "nyc", table_name = "raw_green", transformation_ctx = "datasource0")
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://nanhyama-nyc/staging/green"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]
datasink4 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields3, connection_type = "s3", connection_options = {"path": "s3://nanhyama-nyc/transformed/green"}, format = "parquet", transformation_ctx = "datasink4")
job.commit()
